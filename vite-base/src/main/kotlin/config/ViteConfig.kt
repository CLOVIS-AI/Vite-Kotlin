...
interface ViteConfig {
	...
	fun setDefaults() {
		// Root
		version.convention("8.0.0-beta.18") // https://www.npmjs.com/package/vite
	...
	fun setDefaultsFrom(other: ViteConfig) {
		...
		cacheDir.convention(other.cacheDir)
	...
	/**
	 * Directory to save cache files. Files in this directory are pre-bundled deps or some other cache files generated by vite,
	 * which can improve the performance.
	 *
	 * The value can be either an absolute file system path or a path relative to project [root].
	 */
	@get:Internal
	val cacheDir: Property<String>
